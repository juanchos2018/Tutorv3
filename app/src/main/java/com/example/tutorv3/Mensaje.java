...
import com.example.tutorv3.ClasesAdmin.OtpReceivedInterface;
import com.example.tutorv3.ClasesAdmin.SmsBroadcastReceiver;
...
public class Mensaje extends AppCompatActivity  implements GoogleApiClient.ConnectionCallbacks,
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override public void onSuccess(Void aVoid) {
               ...
               layoutVerify.setVisibility(View.VISIBLE);
                Toast.makeText(Mensaje.this, "SMS Retriever starts", Toast.LENGTH_LONG).show();
            }
        });
        mTask.addOnFailureListener(new OnFailureListener() {
            @Override public void onFailure(@NonNull Exception e) {
                Toast.makeText(Mensaje.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
    }
